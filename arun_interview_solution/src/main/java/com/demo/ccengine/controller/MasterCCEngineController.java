...
@RestController
public class MasterCCEngineController {

	@Autowired
	@Qualifier("MasterCCEngineServiceImpl")
	private ICCEngineService ccEngineService;

	@GetMapping(path = "/CCEngine/Master/{noOfCards}", produces = MediaType.APPLICATION_JSON_VALUE)

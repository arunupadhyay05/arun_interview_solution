...
@RestController
public class DiscoverCCEngineController {

	@Autowired
	@Qualifier("DiscoverCCEngineServiceImpl")
	private ICCEngineService ccEngineService;

	@GetMapping(path = "/CCEngine/Discover/{noOfCards}", produces = MediaType.APPLICATION_JSON_VALUE)

...
@Service("MasterCCEngineServiceImpl")
public class MasterCCEngineServiceImpl implements ICCEngineService {

	private static final Logger LOGGER = LoggerFactory.getLogger(MasterCCEngineServiceImpl.class);
	...
	public Set<CreditCard> generateCreditCards(Integer noOfCards) {
		Set<CreditCard> creditCardSet = cardNumberGenerator.generateCardNumber(
				CreditCardType.MASTER, noOfCards);
		...
		LOGGER.info("Total No of cards:"+validatedCreditCardSet.size()+", Master Cards List: "+validatedCreditCardSet);
